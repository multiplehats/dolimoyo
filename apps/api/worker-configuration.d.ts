/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec4e9b140971910a9078875408ea788b)
// Runtime types generated with workerd@1.20260430.1 2025-11-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SubscriptionActor" | "SourceActor";
	}
	interface Env {
		...
		SOURCE_ACTOR: DurableObjectNamespace<import("./src/index").SourceActor>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "FROM_NAME" | "ADMIN_SECRET" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}
